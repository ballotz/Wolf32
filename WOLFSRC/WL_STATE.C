...
statetype states[state_countof];

void	SpawnNewObj (uint16_t tilex, uint16_t tiley, uint16_t state);
void	NewState (objtype *ob, uint16_t state);
...
void SpawnNewObj (uint16_t tilex, uint16_t tiley, uint16_t state)
{
	...
	GetNewActor ();
	new->state = state;
	if (GETSTATE(state).tictime)
		new->ticcount = US_RndT () % GETSTATE(state).tictime;
	else
		new->ticcount = 0;
...
{
	ob->state = state;
	ob->ticcount = GETSTATE(state).tictime;
}
...
void DropItem (stat_t itemtype, int16_t tilex, int16_t tiley)
{
...
extern void AgentMakeStates(void);
extern void Act2MakeStates(void);
extern void Act2GuardsMakeStates(void);
#ifndef SPEAR
extern void Act2GhostsMakeStates(void);
#endif
extern void Act2DogsMakeStates(void);
extern void Act2OfficersMakeStates(void);
extern void Act2MutantMakeStates(void);
extern void Act2SSMakeStates(void);
#ifndef SPEAR
extern void Act2HansMakeStates(void);
extern void Act2GretelMakeStates(void);
#endif
#ifndef SPEAR
extern void Act2SchabbMakeStates(void);
extern void Act2GiftMakeStates(void);
extern void Act2FatMakeStates(void);
extern void Act2FakeMakeStates(void);
extern void Act2HitlerMakeStates(void);
#endif
#ifndef SPEAR
extern void Act2BJVictoryMakeStates(void);
#endif

void MakeStates(void)
{
    AgentMakeStates();
    Act2MakeStates();
    Act2GuardsMakeStates();
#ifndef SPEAR
    Act2GhostsMakeStates();
#endif
    Act2DogsMakeStates();
    Act2OfficersMakeStates();
    Act2MutantMakeStates();
    Act2SSMakeStates();
#ifndef SPEAR
    Act2HansMakeStates();
    Act2GretelMakeStates();
#endif
#ifndef SPEAR
    Act2SchabbMakeStates();
    Act2GiftMakeStates();
    Act2FatMakeStates();
    Act2FakeMakeStates();
    Act2HitlerMakeStates();
#endif
#ifndef SPEAR
    Act2BJVictoryMakeStates();
#endif
}
